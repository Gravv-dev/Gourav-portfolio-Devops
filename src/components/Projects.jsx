...
export default function Projects() {
  return (
    <section id="projects" className="border-t border-line-soft py-[88px]">
      <div className="mx-auto max-w-[1120px] px-8">
        <SectionHead index="04" title="Featured projects" />
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          {projects.map((p) => (
            <div key={p.num} className="rounded-md border border-line bg-panel p-[26px] transition-colors hover:border-amber-dim">
